...
$misComidas = ["Clan 6 de Don Lee", "Arroz con Pollo", "Pizza"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Pollo Asado", "Batido de Guineo", "Mamon Chino"]; // Reemplaza con las comidas favoritas de tu amigo
